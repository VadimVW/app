...
class Order(models.Model):
    ...
    status = models.CharField(max_length=50, default="Прийнято", verbose_name="Статус замовлення")
...
class OrderItem(models.Model):
    ...
    dish = models.ForeignKey(to=Dishs, on_delete=models.SET_DEFAULT, null=True, verbose_name="Страва", default=None )
